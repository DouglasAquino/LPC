    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefone_celular', models.CharField(blank=True, help_text='Número do telefone  no formato (99) 99999-9999', max_length=15, null=True, verbose_name='Telefone celular')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_noticias.Pessoa')),
